...
def loadModel():
    ...
    if os.path.exists('model/cnnmodel.json'):
        ...
        emotion_model.add(Conv2D(32, 3, 3, input_shape = (32, 32, 3), activation = 'relu'))
        ...
        hist = emotion_model.fit(X_train, y_train, batch_size=16, epochs=10, shuffle=True, verbose=2)
